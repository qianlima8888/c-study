...
{
    fp = fopen("/home/wode/timelog.txt", "a");
    ...
    fprintf(fp, "start time is %f", ros::Time::now().toSec());
    ...
    if(addScan(*scan, odom_pose))
    {
        ...
        fprintf(fp, "scan processd! time is %f", ros::Time::now().toSec());
        ...
        fprintf(fp, "Get mpose! time is %f. x=%f, y=%f, theta=%f", ros::Time::now().toSec(), mpose.x, mpose.y, mpose.theta);
    ...
    else
    {
        ...
        fprintf(fp, "cannot process scan! time is %f", ros::Time::now().toSec());
    }
